...
const longestSubstringNoRepeatingChars = {
...
const arraysAndStringsCategory = [
  twoSum,
  buyStock,
  containsDuplicate,
  productOfArray,
  ...
  longestSubstringNoRepeatingChars,
